...
export default class Registration extends Component {
  ...
  updateVoterAadhaar = (event) => {
    this.setState({ voterAadhaar: event.target.value });
  };
  registerAsVoter = async () => {
    await this.state.ElectionInstance.methods
      .registerAsVoter(this.state.voterName, this.state.voterAadhaar)
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      ...
                      <input
                        className={"input-r"}
                        type="number"
                        placeholder="eg. 2034542012540454"
                        value={this.state.voterAadhaar}
                        onChange={this.updateVoterAadhaar}
                      />
                    </label>
                  </div>
                  <p className="note">
                    ...
                    provided Aadhaar number number does not matches the account
                    address registered in admins catalogue.
                  </p>
                  <button
                    className="btn-add"
                    disabled={
                      this.state.voterAadhaar.length !== 12 ||
